...
public class DeleteBookingTestC {
    ...
    @Test
    @DisplayName("deleteBooking with booking present, should return status 200 and message")
    public void deleteBookingOk() throws Exception {
        mockMvc.perform(delete("/users/deleteBooking/" + event.getTitle())
                .contentType(MediaType.APPLICATION_JSON)
                .header("Authorization", "bearer " + token)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().string("Booking has been removed"));
    }
    ...
    public void deleteBookingException() throws Exception {
        ...
        mockMvc.perform(delete("/users/deleteBooking/" + event.getTitle())
                ...
                .andExpect(jsonPath("$.message")
                        .value("Cannot find the booking to be deleted"));
    }
}
